...
namespace Mtd.Siri.Core.Serialization.Request.VehicleMonitoring
{
	...
	public class VehicleMonitoringSubscriptionRequest
	{
		...
		public DateTimeOffset InitialTerminationTime { get; set; }

		[XmlElement("VehicleMonitoringRequest")]
		public Request Request { get; set; }

		public VehicleMonitoringSubscriptionRequest(DateTimeOffset initialTerminationTime)
		{
			SubscriberRef = "cumtd";
			SubscriptionIdentifier = "cumtd";
